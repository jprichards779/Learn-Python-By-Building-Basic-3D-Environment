...
to determine the motion of different shapes
"""
...
class World4:
    ...
    def collect_elements(self):
        ...
        M = [Sheet([[x0,y0,z0], [0*x1, y1-10, z1], ob[2], ob[3], [0,0,0]], cam, colour = self.app.sheet_colour, parabolic=False),
             Sheet([[x0,y0,z0], [0*x1, y1+5, z1], ob[2], ob[3], [0,0,0]], cam, colour = self.app.sheet_colour, parabolic=False),
             Sheet([[x0,y0,z0], [0*x1, y1+20, z1], ob[2], ob[3], [0,0,0]], cam, colour = self.app.sheet_colour, parabolic=False),
             
             Cylinder([[x0,y0,z0+1.5], [x1-50, y1-1.5, z1], [ob[2][0]+90, ob[2][1], ob[2][2]], ob[3], ob[4]],
                       cam, self.app.cylinder_colour, front=1,back=1.8,l=0.5, hole_size=0, sides = "top,front"),
             Cylinder([[x0,y0,z0+1.5], [x1-50, y1+1.5, z1], [ob[2][0]+90, ob[2][1], ob[2][2]], ob[3], ob[4]],
                       cam, self.app.cylinder_colour, front=1.8,back=1,l=0.5, hole_size=0, sides = "top,back"),
             Cylinder([[x0,y0,z0+1.5], [x1-50, y1, z1], [ob[2][0]+90, ob[2][1], ob[2][2]], ob[3], ob[4]],
                       cam, self.app.cylinder_colour, front=1,back=1,l=2.5, hole_size=0, sides = "top"),
