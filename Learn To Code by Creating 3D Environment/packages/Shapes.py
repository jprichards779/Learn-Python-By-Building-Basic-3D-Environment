...
Data is fed into all instances of this class, which instanciates the Transform 
class and stores data to be fed into the inot the screen class via World class. 
...
The cubic() function form shape_functions module is designed to be maliable 
...
class Sheet:
    ...
    def collect_elements(self):
        ...
        M = [Tile([ob[0], [x+i,y+j,z], ob[2], ob[3], ob[4]], 
